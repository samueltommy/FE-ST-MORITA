...
export const DEMO_USERS: Record<UserRole, UserProfile> = {
  ...
  SUPER_ADMIN: {
    ...
    permissions: ['*'],
    plantLocation: 'Main Plant - Group HQ',
    status: 'ACTIVE',
  ...
  DIREKSI: {
    ...
    permissions: ['*'],
    plantLocation: 'Main Plant - Executive Suite',
    status: 'ACTIVE',
  ...
  HRD_MANAGER: {
    ...
    plantLocation: 'Plant 1 - Administration Wing',
    status: 'ACTIVE',
  ...
  PPIC_MANAGER: {
    ...
    plantLocation: 'Plant 1 - Production Floor',
    status: 'ACTIVE',
  ...
  PURCHASING_MANAGER: {
    ...
    plantLocation: 'Plant 2 - Supply Chain Office',
    status: 'ACTIVE',
  ...
  QC_MANAGER: {
    ...
    plantLocation: 'Main Plant - QA Headquarters',
    status: 'ACTIVE',
  ...
  SALES_MANAGER: {
    ...
    plantLocation: 'Commercial Office & Plant Operations Base',
    status: 'ACTIVE',
  ...
  COST_CONTROL: {
    ...
    plantLocation: 'Main Plant - Finance Dept',
    status: 'ACTIVE',
  ...
  WAREHOUSE_MANAGER: {
    ...
    plantLocation: 'Central Warehouse Bay 4',
    status: 'ACTIVE',
  ...
  OPERATOR_PROD: {
    ...
    plantLocation: 'Plant 1 - Workshop Mesin',
    status: 'ACTIVE',
  ...
  QC_INSPECTOR: {
    ...
    plantLocation: 'Plant 1 - QC Testing Bay',
    status: 'ACTIVE',
  ...
  WAREHOUSE: {
    ...
    plantLocation: 'Central Warehouse Gate 2',
    status: 'ACTIVE',
  ...
  PPIC_PLANNER: {
    ...
    plantLocation: 'Plant 1 - Production Planning',
    status: 'ACTIVE',
...
const INITIAL_QUOTATIONS: Quotation[] = [
  ...
  },
  {
    ...
    customerName: 'PT Samsung Electronics Indonesia',
...
const INITIAL_SALES_VISITS: SalesOutdoorVisit[] = [
  ...
  },
  {
    ...
    clientAddress: 'Kawasan Industri Sentra Manufaktur Blok C-1',
  ...
  approveVehicleBooking: (bookingId: string) => {
    updateGlobalState((prev) => {
      ...
      const audit = createAuditLog(
        ...
        'SYSTEM',
        bookingId,
        `Persetujuan penggunaan armada pabrik ID: ${bookingId}`
      );
